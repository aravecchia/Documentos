...
\title{
    \huge{
		\vspace{-10mm}
	\resizebox{100mm}{10mm}{\color{black}{A Verdade da Vida,}}
	\\
	\vspace{8mm}
	\resizebox{100mm}{10mm}{\color{black}\textbf{do Universo}}
	\\
	\vspace{6mm}
	\resizebox{50mm}{8mm}{\color{black}{e tudo mais.}}
	\\
	\vspace{10mm}
	\resizebox{260mm}{10mm}{\color{black}{Projeto Pedag\'{o}gico:  Inform\'{a}tica e Alfabetização Digital}}
	\\
	\vspace{2mm}
	\resizebox{160mm}{6mm}{\color{black}{Escola Municipal Professor Paulista - Tabatinga - SP}}
		\\
		\vspace{2mm}
...
\author {\Huge \\\vspace{5mm}\resizebox{120mm}{6mm}{\color{black}Alexandre Aravecchia}}
...
\lhead{\large \sffamily Projeto Pedag\'{o}gico de Inform\'{a}tica}
\chead{\large \sffamily %\textbf
%	{ \hyperref
%{www.escoladeimpressao3d.com.br}
%{category}
%{name}
	{E. M. Professor Paulista}}
%	}
...
\pagecolor{white} 
\color{black}
%CHAMADA DE CONFIGURACOES PARA CÓDIGO-FONTE EM ARDUIN
...
%    \CenterWallPaper{1.05}{./IMG/latex.png}	
    %\noindent
